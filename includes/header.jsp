<%-- 
    Document   : header
    Created on : 19/11/2024, 09:21:27 PM
    Author     : rodri
--%>
...
<html>
    <head>
        ...
        <title>EXAMEN RODRIGO QUINTANA PÉREZ</title>
    ...
    <body style="background-color: #D83512">
        <div class="container">
            <div class="jumbotron">
                <center><h2>EXAMEN RODRIGO QUINTANA PÉREZ<img src="imagenes/img.png" class="img img-responsive" alt="logo" style="width: 50px; height: auto; margin-left: 10px; vertical-align: middle;"></h2></center>
            </div>
        </div>
